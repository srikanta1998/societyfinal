...
<h5 style={{ color: 'orange', marginTop: 'auto', marginBottom: '15px', marginLeft: 'auto', marginRight: '15px', textAlign: 'left'}}>Welcome<br/> <b> {memberDetails.firstName} {memberDetails.lastName} </b> </h5>
</div>
{/* -------------------------------------------------------------------------------------------------------------------------------- */}
<div class="navbar" style={{ display: 'flex', justifyContent: 'left'}}>
        ...
        <div style={{ marginLeft: '5px' }}>
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item onClick={handleComplaintModalOpen}><ContentPasteSearchIcon /><span>  </span>Complaints/Suggestions</Dropdown.Item><hr/>
                        <Dropdown.Item onClick={handleEvents}><EventIcon /><span>  </span>Events</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
        </div>
...
{/* --------------------------------------------------------------------------------------------------------------------------- */}
  ...
  <DraftsIcon style={{marginLeft: '75px', marginRight: '10px'}}/> <b style={{marginRight: '75px'}}>Notices</b>
  </Fab>
  </div><br/>

  {notices.length > 0 ? (
  <div style={{textAlign: 'center'}} className="carousel-container">
  <Carousel>
    {notices.map((notice) => (
...
{/* ------------------------------------------------------------------------------------------------------------------------- */}
          ...
          {renderTable1()}
          <div style={{ marginTop: '10px' }}>
          <button className='btn btn-info' onClick={handleClick5}><h6>{showTable1 ? 'Close' : 'Contest in Elections'}</h6></button>
          </div> 
          </>
          </td>
          </tr>
